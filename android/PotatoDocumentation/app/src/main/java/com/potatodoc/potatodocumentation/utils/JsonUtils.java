...
import com.potatodoc.potatodocumentation.data.sync.HttpConnection;
...
public class JsonUtils {
    ...
    private static final AtomicInteger openHttpConnections = new AtomicInteger(0);
     ...
     * <p>
     * This method creates a {@link HttpConnection}-Instance, therefore the String
     * <i>serviceURL</i> is concatenated to {HttpConnection.HOST}. For example
     * to connect to http://google.com/example.php, with {HttpConnection.HOST}
     ...
     * {@link HttpConnection#HttpConnection(java.lang.String, java.util.Map)} for more
     * information.
     * <p>
    ...
    public static ArrayList<Map<String, Object>> getJsonResultArray(String serviceURL,
        ...
        //Create HttpConnection to get URL
        HttpConnection HttpConnection;
        if (params == null) {
            HttpConnection = new HttpConnection(serviceURL);
        } else {
            HttpConnection = new HttpConnection(serviceURL, params);
        }
        ...
        try {
            jsonResult
                    = mapper.readValue(HttpConnection.getResponseStream(), Map.class);
    ...
    /**
     * Returns {getJsonResultArray(java.lang.String, java.lang.String, java.lang.Object, java.lang.String)
    ...
    /**
     * Returns {getJsonSuccessStatus(java.lang.String, java.lang.String, java.lang.Object)
     * } with the following parameters:
     * <pre>
     * serviceURL = serviceURL
     * params = <b>null</b>
    ...
    public static ArrayList<String> getJsonResultArrayList(
    ...
    public static int getOpenHttpConnections() {
        return openHttpConnections.get();
    }
